...
export default function AwarenessPage() {
  ...
  return (
    <div className="bg-pink-50 min-h-screen px-6 py-12">
      {/* Header */}
      <motion.h1
        className="text-4xl text-center font-bold text-pink-700 mb-6"
    ...
    <section className="bg-pink-50 py-16 px-6" ref={ref}>
