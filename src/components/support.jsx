...
export default function SupportResources() {
  return (
    <section className="py-16 px-6 rounded-xl max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg border border-pink-200 shadow-sm">
          <div className="flex items-center gap-3 text-pink-600 mb-3">
            <Phone />
            <h3 className="text-xl font-semibold">Breast Cancer Helplines</h3>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-pink-200 shadow-sm">
          <div className="flex items-center gap-3 text-pink-600 mb-3">
            <Globe />
            <h3 className="text-xl font-semibold">Online Forums</h3>
          </div>
          <ul className="text-gray-700 list-disc list-inside space-y-2">
        ...
        <div className="bg-white p-6 rounded-lg border border-pink-200 shadow-sm">
          <div className="flex items-center gap-3 text-pink-600 mb-3">
            <Hospital />
            <h3 className="text-xl font-semibold">NGOs & Clinics</h3>
          </div>
          <ul className="text-gray-700 list-disc list-inside space-y-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center text-pink-600 mt-3 underline"
          >
        ...
        <div className="bg-white p-6 rounded-lg border border-pink-200 shadow-sm">
          <div className="flex items-center gap-3 text-pink-600 mb-3">
            <Users />
            <h3 className="text-xl font-semibold">Survivor Communities</h3>
          </div>
          <p className="text-gray-700 mb-2">
            Get inspired by real stories and connect with survivor groups to share experiences and strength.
          </p>
          <ul className="text-pink-700 list-disc list-inside space-y-1">
