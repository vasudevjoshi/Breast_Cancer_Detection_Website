  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-white to-pink-50">
      <div className="max-w-6xl mx-auto">
        <motion.h2
          className="text-3xl font-bold text-pink-600 text-center mb-4"
        ...
        {/* Timeline Cards */}
        <motion.h3
          className="text-xl font-bold text-pink-700 text-center mb-6"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 text-center mb-20">
          {[
            {
              age: "Ages 20–39",
            ...
            <div
              key={index}
              className="bg-white rounded-lg shadow p-5 w-72 border border-pink-100"
            >
        ...
        <div className="text-center mb-12">
          <a
            ...
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white text-sm font-medium py-3 px-6 rounded-full transition"
          >
        ...
        {/* Interactive Quiz */}
        <div className="bg-white border border-pink-200 rounded-xl p-8 max-w-2xl mx-auto text-center shadow-sm">
